...
function parse_nick(setTrigger) {
	...
	img.src = "https://mineskin.eu/skin/" + nickname.value;
}
...
const AccordionItem = ({ header, ...rest }) => (
    <Item
      ...
      header={
        <>
          {header}
          <img className={style.chevron} src="./static/chevron-down.svg" alt="Chevron Down" />
        </>
      }
	...
	let update_pepe = (new_value: ColourOption, actionMeta: ActionMeta<ColourOption>) => {
  	...
  	useEffect(() => {
		...
		skin.onload = () => {
			...
			bandage_set = true;
			skinViewer.loadPanorama("./static/panorama.png");
		};
		...
		<main className={style.main}>
			...
			<div className={style.settings_container} id="settings_container">
				<Accordion transition transitionTimeout={250}>
					<AccordionItem header="1. Загрузка скина" initialEntered>
					...
					<AccordionItem header="3. Основные настройки">
					...
					<AccordionItem header="4. Скачать готовый скин">
						<div className={style.styles_main} style={{display: "flex", alignItems: "center", marginBottom: "1rem"}}>
			...
			<footer>
				<h3>Created by <a href="https://andcool.ru" target="_blank">AndcoolSystems</a><br/>Production: <a href="https://vk.com/shapestd" target="_blank">Shape</a> Build: v0.1.3 public-beta</h3>
			</footer>
		</main>
  	);
}