            ...
            <div className={style.main_container}>
                <div className={style.animated}>
                    ...
                    <p style={{ marginLeft: '1rem' }}>
                        <b>1.1</b> Повязки должны так или иначе быть связаны с сервером PepeLand или стримером PWGoood. Все повязки, не имеющие к этому отношению будут отклонены.<br />
                        <b>1.2</b> Все повязки должны являться повязками. Все сторонние изображения, подошедшие под их размер будут отклонены.<br />
                        <b>1.3</b> Запрещено использование на повязке слов/символик, запрещённых на территории РФ, а так же запрещённых правилами пользования сервисами Twitch, Discord, YouTube.<br />
                        <b>1.4</b> Все повязки являются собственностью их автора и отражают только его точку зрения. Администрация сайта не несёт ответственности за публикуемый на сайте контент.<br />
                        <b>1.5</b> Запрещена публикация чужих работ без разрешения/указания автора. В подобных случаях, по заявлению автора повязки, она будет полностью удалена с сайта. Примечание: это не относится к повязкам, автор которых был утерян или прошло достаточно времени, чтобы повязка считалась работой без автора.<br />
                        <b>1.6</b> Запрещена повторная публикация повязок, которые уже существуют, были отклонены или удалены Администрацией.<br />
                    </p>
                    ...
                    <h1 style={{ marginTop: '1rem', fontSize: '1.8rem' }} id="PP">Политика конфиденциальности</h1>
