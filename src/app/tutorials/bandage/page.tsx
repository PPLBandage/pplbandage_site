        ...
        <main className={style.main}>
            <div className={style.main_container}>
                ...
                <div className={style.animated} id='tutorials'>
                    ...
                    <p>Этот метод все еще доступен на странице создания, но его использование в разы сложнее нового.
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <p style={{ margin: 0 }}>Диапазон позиций вычисляется как 12-<span style={{ color: "rgba(12, 247, 215)" }}>`высота повязки`</span>.</p>
                        </li>
                    </ol>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <p style={{ margin: 0 }}> После определения размеров повязки, нужно разделить её на слои.<br />
                                Создайте новый <span style={{ color: "rgba(12, 247, 215)" }}>`.png`</span> файл шириной 16 пикселей и высотой, вдвое большей высоте повязки. Поместите второй слой в верхнюю половину файла, а первый — в нижнюю.</p>
                            <h4 style={{ marginBottom: '.5rem' }}>Пример:</h4>
